	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Emoclëw|Bleeding Hollow|Horde|52|SHAMAN", -- [2]
				"Emogin|Bleeding Hollow|Horde|60|WARLOCK", -- [3]
				"Holynoly|Bleeding Hollow|Horde|60|PRIEST", -- [4]
				"Inolie|Bleeding Hollow|Horde|49|DEATHKNIGHT", -- [5]
				"Nolieper|Bleeding Hollow|Horde|49|DEMONHUNTER", -- [6]
				"Pándan|Bleeding Hollow|Horde|60|PALADIN", -- [7]
				"Stryfë|Bleeding Hollow|Horde|60|HUNTER", -- [8]
				"Trublmakr|Bleeding Hollow|Horde|60|MAGE", -- [9]
			},
		},
	},
	["profileKeys"] = {
	...
	["profiles"] = {
		...
		["Trublmakr - Bleeding Hollow"] = {
			["BlackBook"] = {
				["recent"] = {
					"Holynoly|Bleeding Hollow|Horde", -- [1]
					"Emoclëw|Bleeding Hollow|Horde", -- [2]
		...
		["Stryfë - Bleeding Hollow"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Noliee-BleedingHollow|Bleeding Hollow|Horde", -- [3]
