...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Blù|Bleeding Hollow|Horde|48|MONK", -- [1]
				"Diá|Bleeding Hollow|Horde|48|ROGUE", -- [2]
				"Dorkks|Wyrmrest Accord|Alliance|110|HUNTER", -- [3]
				"Emoclëw|Bleeding Hollow|Horde|51|SHAMAN", -- [4]
				"Emogin|Bleeding Hollow|Horde|60|WARLOCK", -- [5]
				"Happybirth|Tichondrius|Horde|1|PRIEST", -- [6]
				"Holynoly|Bleeding Hollow|Horde|60|PRIEST", -- [7]
				"Inolie|Bleeding Hollow|Horde|48|DEATHKNIGHT", -- [8]
				"Katdoge|Bleeding Hollow|Horde|49|DRUID", -- [9]
				"Noliee|Bleeding Hollow|Horde|48|WARRIOR", -- [10]
				"Nolieper|Bleeding Hollow|Horde|48|DEMONHUNTER", -- [11]
				"Pándan|Bleeding Hollow|Horde|60|PALADIN", -- [12]
				"Stryfë|Bleeding Hollow|Horde|60|HUNTER", -- [13]
				"Trublmakr|Bleeding Hollow|Horde|60|MAGE", -- [14]
			},
		},
	},
	["profiles"] = {
		["Katdoge - Bleeding Hollow"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Dorkk-BleedingHollow|Bleeding Hollow|Horde", -- [3]
					"Unorthodorkk|Bleeding Hollow|Horde", -- [4]
		...
		["Trublmakr - Bleeding Hollow"] = {
			["BlackBook"] = {
				["recent"] = {
					"Holynoly|Bleeding Hollow|Horde", -- [1]
					"Nolieper|Bleeding Hollow|Horde", -- [2]
					"Emogin|Bleeding Hollow|Horde", -- [3]
					"Pándan|Bleeding Hollow|Horde", -- [4]
					"Blù|Bleeding Hollow|Horde", -- [5]
					"Emoclëw|Bleeding Hollow|Horde", -- [6]
					"Katdoge|Bleeding Hollow|Horde", -- [7]
				},
			},
		},
		["Stryfë - Bleeding Hollow"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Dorkk-BleedingHollow|Bleeding Hollow|Horde", -- [5]
				},
			},
		},
		["Blù - Bleeding Hollow"] = {
