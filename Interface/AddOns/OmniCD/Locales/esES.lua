...
L["Always attach to Blizzard frames. By default, bars attach to whichever frame is visible, and if both are visible UF addon take precedence over Blizzard"] = "Anexar siempre a marcos de Blizzard. Por defecto, las barras se anexan a cualquier marco visible y, si ambos son visibles, el addon de UF tendrá preferencia sobre los de Blizzard."
