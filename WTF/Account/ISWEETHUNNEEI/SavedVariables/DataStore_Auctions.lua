	...
	["global"] = {
		["Characters"] = {
			["Default.Bleeding Hollow.Katdoge"] = {
				["lastUpdate"] = 1532496436,
				["lastVisitDate"] = "2018/07/25 01:27",
			},
			["Default.Bleeding Hollow.Holynoly"] = {
				["lastAuctionsScan"] = 1646805589,
				["lastVisitDate"] = "2022/03/09 00:59",
				["lastUpdate"] = 1646805589,
			},
			["Default.Bleeding Hollow.Stryfë"] = {
				["lastUpdate"] = 1644866965,
				["lastVisitDate"] = "2022/02/14 14:29",
			},
			["Default.Bleeding Hollow.Emogin"] = {
				["lastUpdate"] = 1643668891,
				["lastVisitDate"] = "2022/01/31 17:41",
			},
			["Default.Bleeding Hollow.Pándan"] = {
				["lastUpdate"] = 1643664341,
				["lastVisitDate"] = "2022/01/31 16:25",
			},
		},
	},
}
